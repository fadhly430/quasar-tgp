...
<!-- wallet -->
      <q-list bordered class="rounded-borders bg-white text-white">
        ...
        <q-item v-for="(formdompet, index) in fromdompets" :key="formdompet.id" class="bg-grey-3 text-black" line="1">
          ...
          <q-item-section top class="col-1 gt-xm text-center" style="align : center">
              <q-item-label class="q-mt-sm">{{formdompet.UkuranWallet}}</q-item-label>
          </q-item-section>
          ...
          <q-item-section top class="col-2 gt-xm text-center" style="align : center">
              <q-item-label class="q-mt-sm">{{formdompet.ImgWallet}}</q-item-label>
          </q-item-section>
            ...
            <q-card-section>
              <div id="form" class="q-mx-auto" style="width: 600px">
                <q-form class="q-gutter-md">
                    ...
                    <q-input filled v-model="formwallet.UkuranWallet" label="Ukuran"  lazy-rules :rules="[ val => val && val.length > 0 || 'Please type something']" />
...
export default {
  ...
  methods : {
    ...
    edit(frombaju) {
      try{
        ...
        this.formwallet.UkuranWallet = frombaju.UkuranWallet
  ...
  updated(id){
    ...
    self.fromdompets.NamaWallet, self.fromdompets.UkuranWallet, self.fromdompets.StockWallet, 
