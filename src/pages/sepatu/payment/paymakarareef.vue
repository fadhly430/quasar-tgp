    ...
    <div class="q-pa-md">
        ...
        <div class="row justify-center">
            ...
            <div class="col">
                <div class="row items-center">
                   <div class="col-2">
                    ...
                    <div class="col-4">
                        <div class="text-body1 text-center text-bold"> Makara Reef </div>
                    </div>
                    <div class="col-2"/>
                    <div class="col-4">
                        <div class="text-body2 text-right text-bold">Rp. 419.000</div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="text-right text-bold">Rp.419.000</div>
                </div>
