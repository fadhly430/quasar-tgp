    ...
    <div class="q-pa-md">
        ...
        <div class="row justify-center">
            ...
            <div class="row items-center">
                ...
                <div class="col-3">
                    <div class="text-overline text-bold"> {{images.NamaShoes}} </div>
                </div>
                ...
                <div class="col-2">
                    <div class="text-overline text-body2 text-bold">Rp. {{images.HargaShoes}}</div>
                </div>
            </div>
...
export default {
    ...
    computed: {
        ...
        return  parseInt(this.images.HargaShoes) * parseInt(this.form.Jumlah)
        },
