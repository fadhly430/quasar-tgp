                ...
                <div class="column">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 q-gutter-xl">
                                <q-select outlined v-model="Provinsi" :options="prov" placeholder="Shipping"/>
                            </div>
                            <div class="col-1 q-col-gutter-md"/>
                ...
                <div class="row items-center">
                   <div class="col-2">
                        <q-card class="iconbarang">
                            <q-img src="statics/wallet/w5.jpg"/>
                        </q-card>
                    </div>
                    <div class="col-4">
                        <div class="text-body1 text-center text-bold"> Alder Mojave </div>
                    </div>
                    <div class="col-2"/>
                    <div class="col-4">
