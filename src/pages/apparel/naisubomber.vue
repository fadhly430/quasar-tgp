    ...
    <div class="q-pa-md">
        ...
        <div class="row justify-center">
            ...
            <q-carousel swipeable animated v-model="slide" thumbnails infinite>
                        <q-carousel-slide :name="1" img-src="/statics/apparel/j7.jpg"/>
                        <q-carousel-slide :name="2" img-src="/statics/apparel/j7-1.jpg"/>
                        <q-carousel-slide :name="3" img-src="/statics/apparel/j7-2.jpg"/>
                        <q-carousel-slide :name="4" img-src="/statics/apparel/j7-3.jpg"/>
                    </q-carousel>
            </q-card>
            </div>
            ...
            <div class="col-4">
                ...
                <div class="text-left text-h4 ">Naisu Bomber</div>
                <div style="height: 10px"/>
                <div class="text-left text-body1">Rp. 465.000</div>
                <div style="height: 30px"/>
                <q-separator color="blue-grey-3" inset />
                <div style="height: 30px"/>
                <div class="text-left text-body2">Naisu Bomber Jacket adalah pilihan tepat tentunya tidak salah alamat apabila kamu 
                ...
                <div style="height: 20px"/>
                <q-btn style="background: #283b39; color: white" label="Beli Sekarang" class="full-width" @click="$router.replace('/paynaisubomber')"/>
