    ...
    <div class="q-pa-md">
        ...
        <div class="row justify-center">
            ...
            <q-carousel swipeable animated v-model="slide" thumbnails infinite>
                        <q-carousel-slide :name="1" img-src="/statics/apparel/j3.jpg"/>
                    </q-carousel>
            </q-card>
            </div>
            ...
            <div class="col-4">
                ...
                <div class="text-left text-h4 ">Gomenasai Bomber</div>
                <div style="height: 10px"/>
                <div class="text-left text-body1">Rp. 465.000</div>
                <div style="height: 30px"/>
                <q-separator color="blue-grey-3" inset />
                <div style="height: 30px"/>
                <div class="text-left text-body2">Gomenasai Bomber adalah pilihan tepat tentunya tidak salah alamat apabila kamu 
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div style="height: 30px"/>
                        <div class="text-left text-body2">Navy Light Bomber</div>
                ...
                <div style="height: 20px"/>
                <q-btn style="background: #283b39; color: white" label="Beli Sekarang" class="full-width" @click="$router.replace('/paygomenasaibomber')"/>
