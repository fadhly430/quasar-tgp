  ...
  <q-layout view="hhh lpR fff" class="bg-white">
    ...
    <q-header elevated class="bg-grey-10 text-white " height-hint="100">
      <q-toolbar align="center">
       ...
       <q-item clickable tag="a" target="" @click="$router.replace('TGProject/laccount')" >
         <q-item-section>
       ...
       <q-item  flat round clickable @click="drawer = !drawer">
        ...
        <div class="cart-items">
              ...
              <div class="row justify-center">
                <div class="col-10">
                   <q-item clickable tag="a" target="" @click="$router.replace('TGProject/paymentapparel')" >
                <q-item-section>
        ...
        <q-btn class="text-grey-4"  flat label="SEMUA PRODUCT"> 
            ...
            <q-menu transition-show="jump-down" transition-hide="jump-up">
              ...
              <q-list style="min-width:150px" class="text-center">
                <q-item clickable v-close-popup  @click="$router.replace('TGProject/apparel')">
                  <q-item-section>
                    <q-item-label>Apparel</q-item-label>
                  </q-item-section>
                </q-item>

                <q-item clickable v-close-popup @click="$router.replace('TGProject/wallet')">
                  <q-item-section>
                    <q-item-label>Wallet</q-item-label>
                  </q-item-section>
                </q-item>

              <q-item clickable v-close-popup @click="$router.replace('TGProject/sepatu') ">
                <q-item-section>
  ...
  methods: {
    ...
    return this.$router.push("/search")
      ...
      show(images){
          ...
          this.$router.push('TGProject/paymentapparel')
      }
    }
